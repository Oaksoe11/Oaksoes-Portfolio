...
const Contact = () => {
  ...
  return (
    <div id="contact" className='px-6 sm:px-[8%]
    py-20 scroll-mt-20 bg-[url("/footer-bg-color.png")] bg-no-repeat bg-center
    bg-[length:min(1100px,90%)_auto]'>
        <div className='mx-auto max-w-4xl'>
        <h4 className='text-center text-lg font-Outfit'>
                Connect with me
        </h4>
        <div className='flex flex-col items-center gap-5 sm:flex-row sm:justify-center mt-4'>
                ...
                <ul className='flex gap-4'>
                    <li>
                        ...
                        className="flex  items-center justify-center
                            ...
                            rounded-lg cursor-pointer hover:-translate-y-2 bg-white/80
                    ...
                    <li>
                        <a href="https://www.linkedin.com/in/oak-soe-khant-6875b72a1/" target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center justify-center
                            w-12 sm:w-14 aspect-square border border-gray-400
                            rounded-lg cursor-pointer hover:-translate-y-2 bg-white/80
            ...
            <p className='text-center max-w-2xl mx-auto mt-5 font-Outfit'>
                I'd love to hear from you! If you have any questions, comments,
                or feedback, please use the form below.
            </p>

            <form onSubmit={onSubmit} className='max-w-2xl mx-auto px-0 sm:px-5 mt-10'>
